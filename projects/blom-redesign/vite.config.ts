...
export default defineConfig({
  ...
  // The portfolio serves this from /blom/ locally and from
  // /isaiahramirezdev/blom/ on GitHub Pages, so every asset URL has to be
  ...
  build: {
    ...
    outDir: path.resolve(__dirname, '../../public/blom'),
    emptyOutDir: true,

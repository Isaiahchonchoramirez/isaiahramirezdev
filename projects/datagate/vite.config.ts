...
export default defineConfig({
  ...
  // The portfolio serves this from /datagate/ locally and from
  // /isaiahramirezdev/datagate/ on GitHub Pages, so every asset URL has to be
  ...
  build: {
    ...
    outDir: path.resolve(__dirname, '../../public/datagate'),
    emptyOutDir: true,
